...
export default class WorkExperience extends React.Component{
	render(){
		return (
			<div>
				<h1>Northrop Grumman Corporation       Baltimore, MD</h1>
				<div>
				...
				<h1>Harris Space and Intelligence Systems       Rochester, NY</h1>
				<div>
				...
				<h1>Volvo Group       Hagerstown, MD</h1>
				<div>
				...
				<div>
				<h1>United Refining Company       Warren, PA</h1>
				<div>
